...
class Dijkstra:
    ...
    def mostra_solucao(self, distancias):
        print("menores distancias de {} até todos os outros.".format(self.vertices[self.inicio]))
    ...
    def dijkstra(self):
        ...
        for _ in range(self.tamanho):
            ...
            for vertice in range(self.tamanho):
                if (
                    self.grafo[indice_minimo][vertice] > 0
                    and visitados[vertice] == False
                    and distancia[vertice]
                    > distancia[indice_minimo] + self.grafo[indice_minimo][vertice]
                ):
                    distancia[vertice] = (
                        distancia[indice_minimo] + self.grafo[indice_minimo][vertice]
                    )
